/* Log:
  ...
  TOGO:
  Вставить команды посылки сигнала
  ...
  Соединения:
    ...
    Control button -> "NO" контакты:
      GND
      D5 BSFrance LoRa32u4 (задаётся) NOTE!!! На обратной стороне BSFrance надо перерезать перемычку "DIO10->6 default closed"
  Функции кнопки:
